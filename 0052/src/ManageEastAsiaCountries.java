...
public class ManageEastAsiaCountries {
    ...
    private static ArrayList<Country> lc = new ArrayList<Country>();
    //display menu
    ...
    public static void inputCountry() throws Exception {
        System.out.print("Enter code of contry: ");
        Country country = new Country();
        country.setCountryCode(checkInputString());
        //check code contry exist or not
        if (!checkCountryExist(lc, country.getCountryCode())) {
            System.err.println("Country exist.");
            return;
        }
        System.out.print("Enter name of contry: ");
        country.setCountryName(checkInputString());
        System.out.print("Enter total area: ");
        country.setCountryArea(checkInputDouble());

        System.out.print("Enter terrain of contry: ");

        country.setCountryTerrain(checkInputString());
        lc.add(country);
